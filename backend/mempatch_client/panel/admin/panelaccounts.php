    ...
    <div class="container">
        ...
        <div class="mt-3">
            ...
            <h5 class="md-3">Showing info for
                ...
                <?= $conn->query("SELECT COUNT(*) FROM `accounts`")->fetch_assoc()['COUNT(*)'];  ?> panel account(s):</h5>
            ...
            <table class="table table-hover table-bordered mt-4">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="unselectable" scope="col">Username</th>

                        <th class="unselectable" scope="col">Ban reason</th>

                        <th class="unselectable" scope="col">Role</th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row['ban_reason'] == null) {
                            ...
                            <td class="unselectable">' . $ban . '</td>

                            <td class="unselectable">' . $sub . '</td>
