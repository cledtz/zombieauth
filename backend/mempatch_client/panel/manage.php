...
if (isset($_POST['license']))
{
    ...
    $stmt->bind_param("ss", $_POST['license'], $_SESSION['username']);
    $stmt->execute();
    $resultlicense = $stmt->get_result();

    if ($resultlicense->num_rows == 0)
    {
        echo '<div class="alert alert-danger" role="alert">You do not own this license.</div>';
    }
    else
    {
        if (isset($_POST['reason']))
        {
            if (isset($_POST['ban']))
            {
                ...
                echo '<div class="alert alert-info" role="alert">Banned license.</div>';
            }
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        if ($row['role'] == "administrator")
                        {
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="\panel\admin\managepanelaccounts.php">Manage panel
                                        account</a>
                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <form class="form-inline my-lg-0" action="\panel\info.php" method="GET">
                        ...
                        <input class="form-control mr-sm-2" type="text" placeholder="Go to license ..." name="url"
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="reason" value="" type="text" class="form-control" name="reason"
